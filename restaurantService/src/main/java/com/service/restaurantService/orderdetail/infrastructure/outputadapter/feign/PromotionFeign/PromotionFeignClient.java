...
@FeignClient(name = "promotionClient", url = "https://microservice-promotions-12sn.onrender.com/api/promotion", fallbackFactory = PromotionFeignClientFallbackFactory.class)
